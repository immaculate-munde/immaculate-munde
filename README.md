...
I am a **Frontend Developer** and **Data Analyst** passionate about building digital experiences that are not only beautiful but intelligent.

**My Evolution:**
I specialize in crafting responsive, user-centric interfaces while leveraging data analysis to drive design decisions. Currently, I am expanding my technical horizon into **Backend Development** and **Cybersecurity** to build robust, full-stack applications that are secure by design.

**The Goal:** To engineer secure, data-driven platforms where performance meets protection.
...
![Cybersecurity](https://img.shields.io/badge/-Cybersecurity-E34F26?style=flat&logo=kali-linux&logoColor=white)


🛠️ *Currently learning:* Backend Web Development, Cybersecurity
...
- 🌐 Portfolio: [munde](https://mundeimmaculate.vercel.app/)
